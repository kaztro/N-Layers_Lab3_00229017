package com.uca.actLab3.controller;
...
public class MainController {
	...
	public List<Student> ejemplo2(){
		return Arrays.asList(
				new Student("German", "Castro", "08/03/2017", "Ingeniería Informática", true),
				new Student("Willy", "Rex", "10/03/2015", "Ingenieria en alimentos", true));
	}
